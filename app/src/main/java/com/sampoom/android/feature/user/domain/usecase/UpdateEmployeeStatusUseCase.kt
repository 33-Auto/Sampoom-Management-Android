...
class UpdateEmployeeStatusUseCase @Inject constructor(
    private val repository: UserRepository
) {
    suspend operator fun invoke(employee: Employee, workspace: String): Result<Employee> = repository.updateEmployeeStatus(employee, workspace)
}